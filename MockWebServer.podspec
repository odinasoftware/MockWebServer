...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MockWebServer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MockWebServer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jaehan' => 'odinasoftware@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MockWebServer.git', :tag => s.version.to_s }
